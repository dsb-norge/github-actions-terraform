...
run_step() {
  ...
  (
    ...
    # The adapter reads GITHUB_ACTOR and GITHUB_WORKFLOW into the document; a runner's own values
    # would leak into every expected document when this suite runs in CI.
