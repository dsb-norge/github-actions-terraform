...
- **A structural test that greps the workflow must strip comment lines first.** The workflow explains the wrong forms in prose; a negative grep matched its own warning. Same report as P33b.
