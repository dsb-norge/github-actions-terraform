#!/bin/env bash
#
# Local testing/debugging script for step_parse_apply_output.sh
...
export input_apply_console_file="${_this_script_dir}/test-data/apply_with_progress_ticks.log"
...
echo ""
echo "========================================"
echo "Filtered console file:"
echo "========================================"
cat "$(grep '^filtered-console-file=' "${GITHUB_OUTPUT}" | cut -d= -f2-)"
